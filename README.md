...
### Notes
- OpenSSL version Node.js is using dropped support for aes-128-ctr long ago (unless --openssl-legacy-provider flag is used), so [@noble/ciphers](github.com/paulmillr/noble-ciphers) is used
